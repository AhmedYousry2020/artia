...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Faqs Listing</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Faqs Listing</li>
                <!--end::Item-->
    ...
    <div class="content flex-row-fluid" id="kt_content" data-select2-id="select2-data-kt_content">
        ...
        <div class="card pt-4 mb-6 mb-xl-9">
            ...
            <div class="card-header border-0">
                ...
                <div class="card-toolbar">
                    <a href="{{route('dashboard.faqs.create')}}" class="btn btn-sm btn-flex btn-light-primary">
      ...
      <div class="py-0">
        ...
        <div class="py-3 d-flex flex-stack flex-wrap">
            <!--begin::Toggle-->
            <div class="d-flex align-items-center collapsible rotate collapsed" data-bs-toggle="collapse" href="#kt_ecommerce_customer_addresses_{{$faq->id}}" role="button" aria-expanded="true" aria-controls="kt_customer_view_payment_method_1">
                <!--begin::Arrow-->
                ...
                <div class="me-3">
                    <div class="d-flex align-items-center">
                        <div class="fs-4 fw-bold">{{$faq->{'question_'.getLocale()} }}</div>
                    </div>
                </div>
                <!--end::Summary-->
            </div>
            ...
            <div class="d-flex my-3 ms-9" >
                <!--begin::Edit-->
                <a href="{{route('dashboard.faqs.edit',$faq->id)}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                ...
                <!--end::Edit-->
                <!--begin::Delete-->
                <a href="#" onclick="deleteItem(this)" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 delete" data-kt-ecommerce-category-filter="delete_row" data-id="{{$faq->id}}" data-route="{{route('dashboard.faqs.destroy', $faq->id)}}" data-token="{{ csrf_token() }}" data-type="DELETE">
        ...
        <!--end::Header-->
        <!--begin::Body-->
        <div id="kt_ecommerce_customer_addresses_{{$faq->id}}" class="fs-6 ps-9 collapse" data-bs-parent="#kt_ecommerce_customer_addresses" style="">
            <!--begin::Details-->
            <div class="d-flex flex-column pb-5">
                <div class="text-muted">{{$faq->{'answer_'.getLocale()} }}</div>
            </div>
            <!--end::Details-->
        </div>
        <!--end::Body-->
