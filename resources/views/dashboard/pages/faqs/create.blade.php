...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Add Faq</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Add Faq</li>
                <!--end::Item-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="question_en" class="form-control mb-2" placeholder="Faq Question English">
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="question_ar" class="form-control mb-2" placeholder="Faq Question Arabic">
                                <!--end::Input-->
                                <!--begin::Description-->
                        ...
                        <div class="mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea class="required form-control" name="answer_en"  rows="10" ></textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                             ...
                             <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="required form-control" name="answer_ar"  rows="10" ></textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
