...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Footer Settings</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <li class="breadcrumb-item text-white opacity-75">Footer Settings</li>
...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        <form id="about-setting" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
            @csrf
            <input type="hidden" name="page" value="footer_settings">
            <!--begin::Aside column-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Footer Title English</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="footer_title_en" class="form-control mb-2" placeholder="Footer Title English" value="{{ get_setting('footer_title_en') }}">
                            <input type="hidden" name="types[]" value="footer_title_en">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A footer tittle english is required and recommended to be unique.</div>
                            <!--end::Description-->
                        ...
                        <!--end::Input group-->
                          ...
                          <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Footer Title Arabic</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="footer_title_ar" class="form-control mb-2" placeholder="Title Arabic" value="{{ get_setting('footer_title_ar') }}">
                            <input type="hidden" name="types[]" value="footer_title_ar">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A footer tittle is required and recommended to be unique.</div>
                            <!--end::Description-->
                        <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                        <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Footer Description English</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="footer_description_en" class="form-control mb-2" placeholder="Footer Description English" value="{{ get_setting('footer_description_en') }}">
                            <input type="hidden" name="types[]" value="footer_description_en">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A footer description is required and recommended to be unique.</div>
                            <!--end::Description-->
                        <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                        <!--end::Input group-->
                          <!--begin::Input group-->
                          <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Footer Description Arabic</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="footer_description_ar" class="form-control mb-2" placeholder="Footer Description Arabic" value="{{ get_setting('footer_description_ar') }}">
                            <input type="hidden" name="types[]" value="footer_description_ar">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A footer description is required and recommended to be unique.</div>
                            <!--end::Description-->
...
<!--end::Input group-->
                           ...
                           <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Address</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="address" class="form-control mb-2" placeholder="Address" value="{{ get_setting('address') }}">
                            <input type="hidden" name="types[]" value="address">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A Address tittle is required and recommended to be unique.</div>
                            <!--end::Description-->
                        <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                        <!--end::Input group-->
                             <!--begin::Input group-->
                             <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Phone Number</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="phone_number" class="form-control mb-2" placeholder="Phone Number" value="{{ get_setting('phone_number') }}">
                                <input type="hidden" name="types[]" value="phone_number">
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A Phone Number text tittle is required and recommended to be unique.</div>
                                <!--end::Description-->
                            <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                            <!--end::Input group-->
                             <!--begin::Input group-->
                             <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Email</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="email" class="form-control mb-2" placeholder="Email" value="{{ get_setting('email') }}">
                            ...
                            <!--end::Input group-->
                               ...
                               <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Facebook Link</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="facebook_link" class="form-control mb-2" placeholder="Facebook Link" value="{{ get_setting('facebook_link') }}">
                                <input type="hidden" name="types[]" value="facebook_link">
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A Facebook Link  is required and recommended to be unique.</div>
                                <!--end::Description-->
                            <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                            <!--end::Input group-->
                              ...
                              <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Twitter Link</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="twitter_link" class="form-control mb-2" placeholder="Twitter Link" value="{{ get_setting('twitter_link') }}">
                                <input type="hidden" name="types[]" value="twitter_link">
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A Twitter Link  is required and recommended to be unique.</div>
                                <!--end::Description-->
                            <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Instgram Link</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="instgram_link" class="form-control mb-2" placeholder="Instgram Link" value="{{ get_setting('instgram_link') }}">
                                <input type="hidden" name="types[]" value="instgram_link">
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A Instgram Link  is required and recommended to be unique.</div>
                                <!--end::Description-->
                            <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty"></div></div></div>
                            <!--end::Input group-->
