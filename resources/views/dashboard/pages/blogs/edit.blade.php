    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Edit Blog</li>
                <!--end::Item-->
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <style>.image-input-placeholder { background-image: url("{{ $blog->image ? asset('storage/uploads/'.$blog->image) : asset('dashboard-assets/media/svg/files/blank-image.svg')}}"); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url("{{asset('dashboard-assets/media/svg/files/blank-image-dark.svg')}}"); }</style>
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" aria-label="Change avatar" data-bs-original-title="Change avatar" data-kt-initialized="1">
                                ...
                                <!--end::Icon-->
                                <!--begin::Inputs-->
                                <input type="file" name="image" value="{{$blog->image}}" accept=".png, .jpg, .jpeg">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="title_en" class="form-control mb-2" placeholder="Blog Title English" value="{{$blog->title_en}}">
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                           ...
                           <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="title_ar" class="form-control mb-2" placeholder="Blog Title Arabic" value="{{$blog->title_ar}}">
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <div class="mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea class="required form-control" name="body_en"  rows="10" >{{$blog->body_en}}</textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                              ...
                              <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="required form-control" name="body_ar"  rows="10" >{{$blog->body_ar}}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
...
<script>
    $(document).ready(function() {
        $('#blog-create').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{!! route('dashboard.blogs.update',$blog->id) !!}',
                data: formData,
                contentType: false,
                processData: false,
