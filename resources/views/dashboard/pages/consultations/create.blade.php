...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Add Consultation</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Add Consultation</li>
                <!--end::Item-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name_en" class="form-control mb-2" placeholder="Consultation Name English">
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name_ar" class="form-control mb-2" placeholder="Consultation Name Arabic">
                                <!--end::Input-->
                                <!--begin::Description-->
...
<script>
    $(document).ready(function() {
        $('#consultation-create').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{!! route('dashboard.consultations.store') !!}',
                data: formData,
                contentType: false,
                processData: false,
