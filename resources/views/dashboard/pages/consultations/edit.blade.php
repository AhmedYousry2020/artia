...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Edit Consultation</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Edit Consultation</li>
                <!--end::Item-->
...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        <form id="consultation-create" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
            @csrf
            @method('PUT')
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <h2 class="required">consultation Image</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" aria-label="Change avatar" data-bs-original-title="Change avatar" data-kt-initialized="1">
                                ...
                                <!--end::Icon-->
                                <!--begin::Inputs-->
                                <input type="file" value="{{$consultation->image}}" name="image"  accept=".png, .jpg, .jpeg">
                                <!--end::Inputs-->
                            </label>
                            <!--end::Label-->
                            <!--begin::Cancel-->
                        ...
                        <!--end::Image input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">Set the consultation  thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                        <!--end::Description-->
                        @error('image')
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Consultation Name English</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name_en" class="form-control mb-2" value="{{$consultation->name_en}}" placeholder="Consultation Name English">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A consultation name english is required and recommended to be unique.</div>
                            <!--end::Description-->
                            @error('name_en')
                            <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty">{{$message}}</div> </div>
                            @enderror
                        ...
                        <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Consultation Name Arabic</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name_ar" class="form-control mb-2" value="{{$consultation->name_ar}}" placeholder="Consultation Name Arabic">
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">A consultation name arabic is required and recommended to be unique.</div>
                                <!--end::Description-->
                                @error('name_ar')
                                <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty">{{$message}}</div> </div>
                                @enderror
                        ...
                        <div class="mb-10">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Consultation Description English</label>
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea class="required form-control" name="description_en"  rows="10" >{{$consultation->description_en}}</textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set a consultation description english for better visibility.</div>
                            <!--end::Description-->
                        ...
                        <!--end::Input group-->
                             ...
                             <div class="mb-10">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Consultation Description Arabic</label>
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="required form-control" name="description_ar"  rows="10" >{{$consultation->description_ar}}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set a consultation description arabic for better visibility.</div>
                                <!--end::Description-->
...
<script>
    $(document).ready(function() {
        $('#consultation-create').submit(function(e) {
            e.preventDefault();
            var formData = new FormData($(this)[0]);
            // Send an AJAX request
            $.ajax({
                type: 'POST',
                url: '{!! route('dashboard.consultations.update',$consultation->id) !!}',
                data: formData,
                contentType: false,
                processData: false,
