...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Add Doctor</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Add Doctor</li>
                <!--end::Item-->
...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        <form id="doctor-create" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
            @csrf
            <!--begin::Aside column-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <h2 class="required">Doctor Image</h2>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <!--end::Image input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">Set the doctor  thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                        <!--end::Description-->
                        @error('image')
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Doctor Name English</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name_en" class="form-control mb-2" placeholder="Doctor Name English">
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A doctor name english is required and recommended to be unique.</div>
                            <!--end::Description-->
                            @error('name_en')
                            <div class="fv-plugins-message-container invalid-feedback"><div data-field="title" data-validator="notEmpty">{{$message}}</div> </div>
                            @enderror
                        ...
                        <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Doctor Name Arabic</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name_ar" class="form-control mb-2" placeholder="Doctor Name Arabic">
                                <!--end::Input-->
                                <!--begin::Description-->
                        ...
                        <div class="mb-10">
                            <!--begin::Label-->
                            <label class="required form-label form-control-solid">Doctor Description English</label>
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea class="required form-control" name="description_en"  rows="10" ></textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set a doctor description english for better visibility.</div>
                            <!--end::Description-->
                        ...
                        <!--end::Input group-->
                             ...
                             <div class="mb-10">
                                <!--begin::Label-->
                                <label class="required form-label form-control-solid">Doctor Description Arabic</label>
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="required form-control" name="description_ar"  rows="10" ></textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set a doctor description arabic for better visibility.</div>
                                <!--end::Description-->
 ...
 <div class="mb-10">
    ...
    <!--end::Label-->
    <!--begin::Editor-->
    <textarea class="required form-control" name="educational_qualifications_en"  rows="10" ></textarea>
    <!--end::Editor-->
    <!--begin::Description-->
...
<!--end::Input group-->
 ...
 <div class="mb-10">
    ...
    <!--end::Label-->
    <!--begin::Editor-->
    <textarea class="required form-control" name="educational_qualifications_ar"  rows="10" ></textarea>
    <!--end::Editor-->
    <!--begin::Description-->
...
<!--end::Input group-->
 ...
 <div class="mb-10">
    ...
    <!--end::Label-->
    <!--begin::Editor-->
    <textarea class="required form-control" name="professional_experience_en"  rows="10" ></textarea>
    <!--end::Editor-->
    <!--begin::Description-->
...
<!--end::Input group-->
 ...
 <div class="mb-10">
    ...
    <!--end::Label-->
    <!--begin::Editor-->
    <textarea class="required form-control" name="professional_experience_ar"  rows="10" ></textarea>
    <!--end::Editor-->
    <!--begin::Description-->
...
<!--end::Input group-->
 ...
 <div class="mb-10">
    ...
    <!--end::Label-->
    <!--begin::Editor-->
    <textarea class="required form-control" name="certificate_en"  rows="10" ></textarea>
    <!--end::Editor-->
    <!--begin::Description-->
...
<!--end::Input group-->
 ...
 <div class="mb-10">
    ...
    <!--end::Label-->
    <!--begin::Editor-->
    <textarea class="required form-control" name="certificate_ar"  rows="10" ></textarea>
    <!--end::Editor-->
    <!--begin::Description-->
...
<!--end::Input group-->
  ...
  <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
    ...
    <!--end::Label-->
    <!--begin::Input-->
    <input type="text" name="video" class="form-control mb-2" placeholder="Doctor Video">
    <!--end::Input-->
    <!--begin::Description-->
...
<script>
    $(document).ready(function() {
        $('#doctor-create').submit(function(e) {
            e.preventDefault();
