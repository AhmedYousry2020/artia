...
<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Edit Doctor</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">Edit Doctor</li>
                <!--end::Item-->
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <style>.image-input-placeholder { background-image: url("{{$doctor->image ? asset('storage/uploads/'.$doctor->image) : asset('dashboard-assets/media/svg/files/blank-image.svg')}}"); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url("{{asset('dashboard-assets/media/svg/files/blank-image-dark.svg')}}"); }</style>
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" aria-label="Change avatar" data-bs-original-title="Change avatar" data-kt-initialized="1">
                                ...
                                <!--end::Icon-->
                                <!--begin::Inputs-->
                                <input type="file"  value="{{$doctor->image}}" name="image"  accept=".png, .jpg, .jpeg">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name_en" value="{{$doctor->name_en}}" class="form-control mb-2" placeholder="Doctor Name English">
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name_ar" value="{{$doctor->name_ar}}" class="form-control mb-2" placeholder="Doctor Name Arabic">
                                <!--end::Input-->
                                <!--begin::Description-->
                        ...
                        <div class="mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea class="required form-control" name="description_en"  rows="10" >{{$doctor->description_en}}</textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                        ...
                        <!--end::Input group-->
                             ...
                             <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea class="required form-control" name="description_ar"  rows="10" >{{$doctor->description_ar}}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
...
<script>
    $(document).ready(function() {
        $('#doctor-create').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{!! route('dashboard.doctors.update',$doctor->id) !!}',
                data: formData,
                contentType: false,
                processData: false,
