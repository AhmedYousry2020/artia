						...
						<div class="container-xxl d-flex align-items-center">
							...
							<div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
								<a href="../../demo2/dist/index.html">
									<img alt="Logo" src="{{asset('dashboard-assets/media/logos/demo2.png')}}" class="logo-default h-25px" />
									<img alt="Logo" src="{{asset('dashboard-assets/media/logos/demo2-sticky.png')}}" class="logo-sticky h-25px" />
								</a>
							</div>
							<!--end::Header Logo-->
							<!--begin::Wrapper-->
														...
														<div class="d-flex w-100 overflow-auto">
															<ul class="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1">
																...
																<li class="nav-item mx-lg-1">
																	<a class="nav-link py-3 py-lg-6 active text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_pages">General Settings</a>
																</li>
																<!--end:Nav item-->
																	...
																	<div class="col-lg-8">
																		...
																		<div class="row">
																			...
																			<div class="col-lg-3 mb-6 mb-lg-0">
																				<!--begin:Menu heading-->
																				<h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">Settings</h4>
																				<!--end:Menu heading-->
																				<!--begin:Menu item-->
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="/dashboard/settings/about_settings" class="menu-link">
																				...
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="/dashboard/settings/footer_settings" class="menu-link">
																						<span class="menu-title">Footer Content</span>
																					</a>
																					<!--end:Menu link-->
																				</div>
																				<!--end:Menu item-->
																				...
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="/dashboard/settings/header_settings" class="menu-link">
																			...
																			<div class="col-lg-3 mb-6 mb-lg-0">
																				<div class="mb-6">
                                                                                    <!--begin:Menu heading-->
																				<h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">Blogs</h4>
																				<!--end:Menu heading-->
																				<!--begin:Menu item-->
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="{{route('dashboard.blogs.create')}}" class="menu-link">
...
<div class="mb-0">
    <!--begin:Menu heading-->
																				<h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">Consultations</h4>
																				<!--end:Menu heading-->
																				<!--begin:Menu item-->
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="{{route('dashboard.consultations.create')}}" class="menu-link">
																						<span class="menu-title">Add Consultation</span>
																					</a>
																					<!--end:Menu link-->
																				</div>
																				<!--end:Menu item-->
																				...
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="{{route('dashboard.consultations.index')}}" class="menu-link">
																						<span class="menu-title">Consultations List</span>
																					</a>
																					<!--end:Menu link-->
																				</div>
																				<!--end:Menu item-->
																			...
																			<div class="col-lg-3 mb-6 mb-lg-0">
																				<div class="mb-6">
                                                                                    <!--begin:Menu heading-->
																				<h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">Doctors</h4>
																				<!--end:Menu heading-->
																				<!--begin:Menu item-->
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="{{route('dashboard.doctors.create')}}" class="menu-link">
																				...
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="{{route('dashboard.doctors.index')}}" class="menu-link">
                                                                                ...
                                                                                <div class="mb-0">
                                                                                    <!--begin:Menu heading-->
																				<h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">Faqs</h4>
																				<!--end:Menu heading-->
																				<!--begin:Menu item-->
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																				...
																				<div class="menu-item p-0 m-0">
																					...
																					<a href="{{route('dashboard.faqs.index')}}" class="menu-link">
																						<span class="menu-title">Faqs List</span>
																					</a>
																					<!--end:Menu link-->
																				</div>
																				<!--end:Menu item-->
...
<!--begin:Menu heading-->
																	...
																	<!--begin:Col-->
																	<div class="col-lg-4">
																		<img src="{{asset('dashboard-assets/media/stock/600x600/img-82.jpg')}}" class="rounded mw-100" alt="" />
																	</div>
																	<!--end:Col-->
																</div>
																<!--end:Row-->
								...
								<div class="topbar d-flex align-items-stretch flex-shrink-0">
														...
														<div class="scroll-y mh-200px mh-lg-350px">
															...
															<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																...
																<div class="symbol symbol-40px me-4">
																	<img src="{{asset('dashboard-assets/media/avatars/300-6.jpg')}}" alt="" />
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
															...
															<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																<!--begin::Symbol-->
																<div class="symbol symbol-40px me-4">
																	<img src="{{asset('dashboard-assets/media/avatars/300-2.jpg')}}" alt="" />
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
																<div class="d-flex flex-column justify-content-start fw-semibold">
															...
															<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																<!--begin::Symbol-->
																<div class="symbol symbol-40px me-4">
																	<img src="{{asset('dashboard-assets/media/avatars/300-9.jpg')}}" alt="" />
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
																<div class="d-flex flex-column justify-content-start fw-semibold">
															...
															<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																<!--begin::Symbol-->
																<div class="symbol symbol-40px me-4">
																	<img src="{{asset('dashboard-assets/media/avatars/300-14.jpg')}}" alt="" />
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
																<div class="d-flex flex-column justify-content-start fw-semibold">
															...
															<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																<!--begin::Symbol-->
																<div class="symbol symbol-40px me-4">
																	<img src="{{asset('dashboard-assets/assets/media/avatars/300-11.jpg')}}" alt="" />
																</div>
																<!--end::Symbol-->
																<!--begin::Title-->
																<div class="d-flex flex-column justify-content-start fw-semibold">
									...
									<div class="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										<!--begin::Menu wrapper-->
										<div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img class="h-30px w-30px rounded" src="{{asset('dashboard-assets/media/avatars/300-2.jpg')}}" alt="" />
										</div>
